package me.brook.hksaves.panels.style;
...
//			BasicGraphicsUtils.drawString(b, (Graphics2D) g, text, rect.x, rect.y + fm.getAscent());
		}
		else {
	...
	private void paintBackground(Graphics g, AbstractButton ab, int yOffset) {
		...
		g.setColor(Colors.CUSTOM_BUTTON_ACCENT);
